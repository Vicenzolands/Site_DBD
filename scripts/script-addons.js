...
const personagens = [
  ...
  //Pig
  {
    ...
    itens: [
      {
        nome: "Fita de vídeo",
        imagem: "../image/addons/Pig/fita-video.webp",
        qualidade: "bom",
      },
      {
        nome: "Carta de Amanda",
        imagem: "../image/addons/Pig/carta-amanda.webp",
        qualidade: "mediano",
      },
      {
        nome: "Cronometro Modificado",
        imagem: "../image/addons/Pig/cronometro-modificado.webp",
        qualidade: "bom",
      },
      {
        nome: "Esboço do Jigsaw",
        imagem: "../image/addons/Pig/esboço-jigsaw.webp",
        qualidade: "muito-bom",
      },
      {
        nome: "Caixa de engrenagens",
        imagem: "../image/addons/Pig/caixote-engrenagens.webp",
        qualidade: "bom",
      },
      {
        nome: "Segredo de Amanda",
        imagem: "../image/addons/Pig/segredo-amanda.webp",
        qualidade: "bom",
      },
      {
        nome: "Tôxina de lenta liberação",
        imagem: "../image/addons/Pig/toxina-lenta-liberação.webp",
        qualidade: "ruim",
      },
      {
        nome: "Espinhos metalicos enferrujados",
        imagem: "../image/addons/Pig/espinhos-metalicos-enferrujados.webp",
        qualidade: "ruim",
      },
      {
        nome: "Conjunto de regras número 2",
        imagem: "../image/addons/Pig/conjunto-regras-numero-2.webp",
        qualidade: "mediano",
      },
      {
        nome: "Esboço de projeto do Jigsaw",
        imagem: "../image/addons/Pig/esboço-projeto-jigsaw.webp",
        qualidade: "bom",
      },
      {
        nome: "Bolsa de engrenagens",
        imagem: "../image/addons/Pig/bolsa-engrenagens.webp",
        qualidade: "bom",
      },
      {
        nome: "Graxa de oficina",
        imagem: "../image/addons/Pig/graxa-oficina.webp",
        qualidade: "muito-bom",
      },
      {
        nome: "Lâminas Utilitárias",
        imagem: "../image/addons/Pig/laminas-utilitarias.webp",
        qualidade: "ruim",
      },
      {
        nome: "Arame farpado",
        imagem: "../image/addons/Pig/arame-farpado.webp",
        qualidade: "ruim",
      },
      {
        nome: "Testamento",
        imagem: "../image/addons/Pig/testamento.webp",
        qualidade: "muito-bom",
      },
      {
        nome: "Máscara facial",
        imagem: "../image/addons/Pig/mascara-facial.webp",
        qualidade: "mediano",
      },
      {
        nome: "Seringa Quebrada",
        imagem: "../image/addons/Pig/seringa-quebrada.webp",
        qualidade: "ruim",
      },
      {
        nome: "Arquivo médico de John",
        imagem: "../image/addons/Pig/arquivo-medico-john.webp",
        qualidade: "mediano",
      },
      {
        nome: "Lâminas Interligadas",
        imagem: "../image/addons/Pig/laminas-interligadas.webp",
        qualidade: "ruim",
      },
      { nome: "Cinta de combate", imagem: "../image/addons/Pig/cinta-combate.webp", qualidade: "mediano" },
    ],
  },
